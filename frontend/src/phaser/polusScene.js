...
import shipImg from '../assets/polusResize.png';
...
import { movePlayer } from './polusMovement';
...
export class PolusGame extends Phaser.Scene {
  ...
  create() {
    ...
    player.sprite = this.add.container(POLUS_PLAYER_START_X, POLUS_PLAYER_START_Y)
