...
import shipImg from '../assets/miraResize.png';
...
export class MiraGame extends Phaser.Scene {
  ...
  create() {
    ...
    player.sprite = this.add.container(MIRA_PLAYER_START_X, MIRA_PLAYER_START_Y)
