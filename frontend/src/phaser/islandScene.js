...
import shipImg from '../assets/islandmapResize.png';
...
import { movePlayer } from './islandMovement';
...
export class IslandGame extends Phaser.Scene {

  constructor() {
    super({ key: 'IslandGame' });
  ...
  create() {
    ...
    player.sprite = this.add.container(ISLAND_PLAYER_START_X, ISLAND_PLAYER_START_Y)
